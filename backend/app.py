...
try:
    ...
    # Fallback to simple model or empty model if en_core_web_sm isn't available
    try:
        nlp = spacy.blank("en")
        print("Using fallback blank English model")
    except:
...
def getPeopleByNLP():
    try:
        ...
        GROQ_API_KEY = os.environ.get("GROQ_API_KEY", "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")
        LINKD_API_KEY = os.environ.get("LINKD_API_KEY", "lk_c32bed2cd3d54b7b8629cce26c1bfb78")
        ...
        print(f"Error in getPeopleByNLP: {e}")
        traceback.print_exc()
...
def getPeople():
    try:
        ...
        GROQ_API_KEY = os.environ.get("GROQ_API_KEY", "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")
        LINKD_API_KEY = os.environ.get("LINKD_API_KEY", "lk_e653221e402747fcb1293b61a1468066")
