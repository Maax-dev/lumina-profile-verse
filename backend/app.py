...
def getPeopleByNLP():
        ...
        messages=[
            {
                "role": "user",
                "content": (
                    f"Write a short natural language search query for  '{statement}'"
                )
            }
        ],
        temperature=0.7,
    ...
    params["school"] = 'any'  # or params["school"] = [aluminiFilter] depending on API handling
